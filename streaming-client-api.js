...
document.querySelector('.generar').addEventListener('click',speech)

      const API_KEY = "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";
      const ELEVEN_LABS_API_KEY="bedb9645d3255a6c8611aca09e899976"
...
async function speech(){
    ...
    reconocer.lang="ES";
    reconocer.start();
    reconocer.onresult=(e)=>{

      console.log(e.results[0][0].transcript)
      oIa=e.results[0][0].transcript;
  ...
  const handleSend = async (s) => {
    await processMessageToChatGPT(s)
  };
  async function processMessageToChatGPT(chatMessages) { 
    await fetch("https://api.openai.com/v1/chat/completions", 
    {
      ...
      ia=data.choices[0].message.content
      console.log(ia)
      let s=data.choices[0].message.content
      return await elevenlabs(s)
    })
  }
  async function elevenlabs(s){
    var oHttp = new XMLHttpRequest();
    oHttp.open("POST", "https://api.elevenlabs.io/v1/text-to-speech/pNInz6obpgDQGcFmaJgB");
